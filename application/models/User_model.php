...
class User_model extends CI_Model {
    ...
    public function upload_user_image($user_id) {
        if (isset($_FILES['user_image']) && $_FILES['user_image']['name'] != "") {
            ...
            upload_video_to_azure($_FILES['user_image']['tmp_name'], 'uploads/user_image/'.$user_id.'.jpg');
        ...
        if ($user_details['email'] == $this->input->post('email')) {
            ...
            if (isset($_FILES['document']) && $_FILES['document']['name'] != "") {
                ...
                if (in_array(strtolower($ext), $accepted_ext)) {
                    ...
                    $this->load->helper('azure_helper');
                    upload_video_to_azure($_FILES['document']['tmp_name'], 'uploads/document/'.$document_custom_name);
                }else{
