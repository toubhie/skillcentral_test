						...
						<div class="item clearfix">
							...
							<div class="item-details">
								<a href="">
									...
									<div class="item-price">
										s
										<?php if ($course_details['when_to_pay_for_certificate'] === "during_course_purchase"){
												if ($course_details['is_free_certificate'] == 0){
													$total_price += $course_details['certificate_price'];?>
													<span class="certificate-price"><?php echo currency($course_details['certificate_price']); ?></span>
											<?php } else{
													//Certificate is free. Add 0
													$total_price += 0;?>
													<span class="certificate-price"><?php echo currency($course_details['certificate_price']); ?></span>
											<?php }
											} ?>
