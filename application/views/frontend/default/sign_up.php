        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5"> <!-- New -->
              <div class="user-dashboard-box mt-3 ab-form-container">
                  ...
                  <div class="user-dashboard-content w-100 login-form hidden ab-form">
                          ...
                          <div class="content-box">
                              <div class="basic-group">
                                  <div class="form-group" id="ab-form-group">
                                      ...
                                      <input type="email" class="form-control" id="ab-form-control" name = "email" id="login-email" placeholder="<?php echo site_phrase('email'); ?>" required>
                                  </div>
                                  <div class="form-group" id="ab-form-group">
                                      ...
                                      <input type="password" class="form-control" id="ab-form-control" name = "password" placeholder="<?php echo site_phrase('password'); ?>" required>
                                  </div>
                              </div>
                          </div>
                  ...
                  <div class="user-dashboard-content w-100 register-form ab-form">
                      <div class="content-title-box">
