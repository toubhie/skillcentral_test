...
-->
            ...
            <div class="form-group row mb-3">
                <label class="col-md-4 col-form-label" for="teams_attendee_url"><?php echo get_phrase('ms_teams_attendee_url'); ?></label>
                <div class="col-md-6">
                    <input type="text" class="form-control" id="teams_attendee_url" name = "teams_attendee_url" placeholder="<?php echo get_phrase('enter_ms_teams_attendee_url'); ?>" value="<?php echo $live_class['teams_attendee_url']; ?>">
                </div>
            </div>
        </div>
        ...
        <div class="col-md-5">
            <div class="alert alert-success text-center" role="alert">
                ...
                <hr>
                <p class="mb-0"><b>NOTE: </b><?php echo get_phrase('confirm_the_attendee_link_is_correct'); ?>.</p>
               <!-- <div class="mt-2">
