  ...
  function payWithPaystack(){
    var handler = PaystackPop.setup({
      ...
      callback: function(response){
        var is_certificate_payment = '<?php echo $is_certificate_payment; ?>';

        if(is_certificate_payment == 1){
          //Callback of certificate 
          location.replace("<?php echo site_url('addons/paystack/paystack_certificate_payment/'.$user_details['id']. '/'. $course_id .'/' .$amount. '/'); ?>");
