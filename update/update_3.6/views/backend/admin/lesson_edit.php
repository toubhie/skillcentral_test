...
<form action="<?php echo site_url('admin/lessons/'.$param3.'/edit'.'/'.$param2); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" data-toggle="select2" name="lesson_type" id="lesson_type" required onchange="show_lesson_type_form(this.value)">
            ...
            <option value="other-iframe" <?php if($lesson_details['attachment_type'] == 'iframe') echo 'selected'; ?>><?php echo get_phrase('iframe_source'); ?></option>
        </select>
    </div>
    ...
    <div class="" id = "other" <?php if($lesson_details['lesson_type'] != 'other' && $lesson_details['attachment_type'] == 'iframe'):?> style="display: none;" <?php endif; ?>>
        <div class="form-group">
    ...
    <div class="" id = "iframe-source" <?php if($lesson_details['lesson_type'] != 'other' && $lesson_details['attachment_type'] != 'iframe'):?> style="display: none;" <?php endif; ?>>
        <div class="form-group">
